...
You MUST return a valid JSON object with this exact structure:
{
  ...
  const tickersByType: Record<string, string[]> = {
    ai:        ['2330', '2454', '3231', '3034', '2376', '6526', '3661', '2382', '4938', '3017', '8069', '2308'], // 台積電、聯發科、緯創、聯詠、技嘉、達發、世芯-KY、廣達、和碩、奇鋐、元太、台達電
    tech:      ['2317', '2382', '2308', '2354', '3008', '2474', '6669', '2353', '2356', '2357', '4938', '3037'], // 鴻海、廣達、台達電、鴻準、大立光、可成、緯穎、宏碁、英業達、華碩、和碩、欣興
    semi:      ['2330', '2303', '2454', '3711', '2379', '5347', '6488', '3105', '3034', '3443', '6770', '3529'], // 台積電、聯電、聯發科、日月光投控、瑞昱、世界、環球晶、穩懋、聯詠、創意、力積電、力旺
    ...
    etf:       ['0050', '0056', '006208', '00878', '00919', '00929', '00713', '00940', '00692', '00891', '00881', '00733'], // 台灣50、高股息、富邦台50、國泰永續高股息、群益台灣精選高息、復華台灣科技優息、元大台灣高息低波、元大台灣價值高息、富邦公司治理、中信關鍵半導體、國泰台灣5G+、富邦臺灣中小
